...
{/* the message */}
        <div> 
          <label htmlFor="message">
            Message {/* Message<span className="text-red-500">*</span> */}
          </label>
          {/* message input arrea */}
          <textarea
            name="message"
...
//             feel free to reach to me with any questions or concerns 
//           </h1>
